...
class SingleAE(object):
    def __init__(self, shape, para, data, layer_idx, modal, activation_fun1, activation_fun2):
        self.para = para
        self.data = data
    ...
    def doTrain(self):
        ...
        for i in range(self.para['iters']):
            ...
            if i % 1000 == 0:
                ...
                print('modal-{}, pretrain layer-{}, epoch-{}, error-{}'.format(self.modal, self.layer_idx, i, error))
